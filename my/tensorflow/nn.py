# from tensorflow.python.ops.rnn_cell import _linear #r0.11
from tensorflow.contrib.rnn.python.ops.core_rnn_cell_impl import _linear  #r1.1
...
def multi_conv1d(in_, filter_sizes, heights, padding, is_train=None, keep_prob=1.0, scope=None):
    with tf.variable_scope(scope or "multi_conv1d"):
        ...
        for filter_size, height in zip(filter_sizes, heights):
            ...
            outs.append(out)
        # concat_out = tf.concat(2, outs) # tf r0.11
        concat_out = tf.concat(outs, 2) # tf r1.1
        return concat_out
