...
# from tensorflow.python.ops.rnn_cell import DropoutWrapper, RNNCell, LSTMStateTuple  #tf r 0.11
from tensorflow.contrib.rnn.python.ops.core_rnn_cell import DropoutWrapper, RNNCell, LSTMStateTuple #tf r 1.1
